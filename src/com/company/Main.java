...
public class Main {
    ...
    public static void printStatistics(int round){
        ...
        System.out.println("Warrior Health " + (heroessHealth[0]+hillngHero));
        System.out.println("Magical Health " + (heroessHealth[1]+hillngHero));
        System.out.println("Kinetic Health " + (heroessHealth[2]+hillngHero));
        System.out.println("Hiller Health " + (heroessHealth [3]+hillngHero));
